...
class SubscriptionController extends Controller
{
    ...
    public function index()
    {
        ...
        })->sortBy('days')->unique('duration')->values();
    ...
    public function success()
    {
        ...
        if (!$paymentInfo || !$plan) {
            Toastr::danger(__('Something went wrong while processing payment!'));
        ...
        if (auth()->user()->current_workspace_id == null) {
            $redirectUrl = '/user/workspaces/create';
            Toastr::info(__('Please add a workspace first'));
        }
