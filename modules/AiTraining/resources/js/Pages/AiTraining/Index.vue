...
const submit = () => {
  form.post(route('user.aitraining.ai-training-credential.store'))
}
...
const importDataset = () => {
  importDatasetFrom.post(route('user.aitraining.ai-training.import-dataset'), {
    onSuccess: () => {
        ...
        <div class="flex items-center justify-between">
          ...
          >
            <ul class="dropdown-list">
              ...
              <li class="dropdown-list-item">
                <Link :href="route('user.aitraining.ai-training.show', key)" class="dropdown-link gap-4">
  ...
  >
    ...
    <div class="flex justify-end gap-3">
      <button
        ...
        @click="deleteRow(route('user.aitraining.ai-training-credential.destroy', formActiveProvider))"
      >
        <Icon icon="bx:trash" />
        {{ trans('Remove') }}
      </button>
