...
const checkStatus = (aiTraining) => {
  router.patch(route('user.aitraining.ai-training.check-status', aiTraining.id))
}
</script>
<template>
            ...
            >
              <ul class="dropdown-list">
                ...
                <li class="dropdown-list-item" v-if="isDev">
                  <Link
                    :href="route('user.aitraining.ai-training.test-prompt', aiTraining.id)"
                    class="dropdown-link"
                  >
                ...
                <li class="dropdown-list-item">
                  <button
                    type="button"
                    class="dropdown-link"
                    @click="deleteRow(route('user.aitraining.ai-training.destroy-record', aiTraining.id))"
                  >
                ...
                <li class="dropdown-list-item">
                  <button
                    type="button"
                    class="dropdown-link"
                    @click="deleteRow(route('user.aitraining.ai-training.destroy', aiTraining.id))"
                  >
                    <Icon icon="bx:trash" />
