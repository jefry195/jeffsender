    ...
    <div v-else class="mt-4 px-1">
      <form @submit.prevent="aiStore.submit" class="space-y-4">
        <div class="flex items-center justify-between">
          ...
          <button class="btn btn-outline-danger btn-xs" @click="
            () => {
    ...
    <form @submit.prevent="sendLocationMessage">
      <div class="grid grid-cols-2 gap-3">
        ...
        <div>
          ...
          <input v-model="locationForm.longitude" type="text" class="input" placeholder="Longitude" />
        </div>
      </div>
      <SpinnerBtn :processing="locationForm.processing" :btn-text="trans('Send')" class="mt-3 w-full" />
    </form>
  </Modal>
</template>
