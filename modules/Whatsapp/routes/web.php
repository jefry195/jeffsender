...
Route::group(['middleware' => ['auth', 'user', 'access_module:whatsapp']], function () {
    ...
    Route::get('platforms/{platform_uuid}/conversations/{conversation_id}', [MODULE\PlatformController::class, 'showConversation'])->name('platforms.conversations.show');
    ...
    Route::post('customers/bulk-delete', [MODULE\CustomerController::class, 'bulkDestroy'])->name('customers.bulk-delete');
